...
function Navbar() {
    return (
        <Container fluid={true} style={{backgroundColor: '#000', fontSize: '1rem', fontWeight: 'light'}}>
            <Row className='d-flex justify-content-between align-items-center text-white' style={{width: '90%', margin: '0 auto'}}>
                <Col md={2}>
